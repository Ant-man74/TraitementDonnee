...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.pool = self.poolingStats(2, 2) # size 2*2
        self.conv2 = self.conv2DStats(6, 16, 5) # size 5*5
        self.relu = self.reluStats
        self.fc1 = self.linearStats(16 * 5 * 5, 120) # size 16 * 5 * 5
    ...
    def runOnData(self, testloader):
        ...
        print('Accuracy of the network on the 10000 (iter '+ str(self.itera) +') test images: %d %%' % (
        100 * correct / total))
